...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 text-black shadow-sm transition-all duration-300">
            <div className="max-w-[1400px] mx-auto px-6 sm:px-12">
                <div className="flex justify-between items-center h-20 md:h-24">
                    ...
                    <div className="flex-shrink-0 flex justify-center">
                        <Link href="/">
                            <span className="font-serif text-3xl font-light tracking-[0.25em] uppercase text-gray-900 border-x border-gray-200 px-8 py-2 hidden sm:block">
                                AKOD
                            </span>
                            <span className="font-serif text-2xl font-light tracking-[0.25em] uppercase text-gray-900 sm:hidden">
                                AKOD
                            </span>
                        </Link>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-end space-x-8">
                        ...
                        <Link href="/cart" className="relative text-gray-800 hover:text-gray-500 transition-colors flex items-center">
